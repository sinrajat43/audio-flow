...
export class MockSpeechClient implements ISpeechClient {
  ...
  async transcribe(audioData: Buffer, language: LanguageCode): Promise<SpeechRecognitionResult> {
    ...
    const transcriptions: Record<string, string> = {
      'en-US':
        'This is a mock transcription in English. The audio has been processed successfully.',
      'fr-FR': "Ceci est une transcription fictive en français. L'audio a été traité avec succès.",
      'es-ES':
        'Esta es una transcripción simulada en español. El audio se ha procesado correctamente.',
      'de-DE':
        'Dies ist eine simulierte Transkription auf Deutsch. Das Audio wurde erfolgreich verarbeitet.',
      'it-IT':
        "Questa è una trascrizione simulata in italiano. L'audio è stato elaborato con successo.",
